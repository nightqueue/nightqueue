...
// Server entry this package wants registered at user scope.
export function desiredServer() {
  return { command: "node", args: [shiftEntryPath(), "mcp"] };
}
...
export function serverIsCurrent(entry) {
  if (!entry || typeof entry !== "object") return false;
  const wanted = desiredServer();
