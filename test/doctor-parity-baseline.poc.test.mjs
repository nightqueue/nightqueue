...
function normalize(text, substitutions) {
  ...
  // The `keep awake` doctor check is the same: a baseline exported before `queue.keepAwake` landed never reports it either; so are `host commands` and `orchestrator`.
