...
registering it, or `NIGHTSHIFT_REFLECT=1`, turns it off (see [Memory](memory.md)).
...
`nightshift update` is how you take the new version (see [Install](install.md) for what it
